    ...
    <section id="proyectos" className="py-24 max-w-6xl mx-auto px-6">
      ...
      >
        {projectData.map((project, index) => {
          // 1. Abrimos llave aquí en vez de paréntesis

          // 2. Definimos la lógica de traducción
          const currentTitle =
            isEnglish && project.title_en ? project.title_en : project.title;
          const currentDesc =
            isEnglish && project.desc_en ? project.desc_en : project.desc;

          // 3. Hacemos el return explícito
          return (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center z-30">
                    <span className="px-5 py-2 bg-white text-slate-950 rounded-full font-bold text-[10px] uppercase tracking-widest shadow-lg relative z-50 hover:bg-cyan-400 transition-colors">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-white mb-2">
                    {/* Quité la palabra 'title' para que solo salga el texto */}
                    {currentTitle}
                  </h3>
