    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8 text-[13px] font-medium tracking-widest">
          <a href="#proyectos" className="text-slate-400 hover:text-white transition-colors">{t('nav.projects')}</a>
          <a href="#servicios" className="text-slate-400 hover:text-white transition-colors">{t('nav.services')}</a>
          <a href="#sobre-mi" className="text-slate-400 hover:text-white transition-colors">{t('nav.about')}</a>
